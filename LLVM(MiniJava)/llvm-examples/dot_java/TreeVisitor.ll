...
define i32 @TV.Start(i8* %this) {
	...
	call void (i32) @print_int(i32 100000000)
	; Allocating object type MyVisitor
...
define i32 @Visitor.visit(i8* %this, i8* %.n) {
	...
	%_5 = bitcast i8* %_4 to i1 (i8*)*
	%_6 = call i1 %_5(i8* %_0)
	br i1 %_6, label %iflabel64, label %ellabel65
...
exitif66:
	...
	br i1 %_31, label %iflabel67, label %ellabel68
...
define i32 @MyVisitor.visit(i8* %this, i8* %.n) {
	...
	%_5 = bitcast i8* %_4 to i1 (i8*)*
	%_6 = call i1 %_5(i8* %_0)
	br i1 %_6, label %iflabel70, label %ellabel71
...
exitif72:
	...
	br i1 %_38, label %iflabel73, label %ellabel74
